...
Traditional CRDT libraries wrap your data in special containers, creating mapping overhead and data duplication. **lithium-crdt** takes a different approach: it maintains a parallel version tree alongside your existing protobuf messages, giving you:
...
dependencies {
    ...
    implementation("co.atoms.lithium.crdt:crdt-protoc-data:1.0.0")
}
```
...
|----------|----------|------------|
| **lithium-crdt** | Parallel version tree | Requires protobuf, field-level granularity |
...
**Questions?** Open an issue or start a discussion. We'd love to hear how you're using lithium-crdt!
