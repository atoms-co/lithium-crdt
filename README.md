...
<!-- [![Maven Central](https://img.shields.io/maven-central/v/io.github.anthropics/protobuf-crdt.svg)](https://search.maven.org/search?q=g:io.github.anthropics%20AND%20a:protobuf-crdt) -->
<!-- [![Build Status](https://github.com/anthropics/protobuf-crdt/workflows/CI/badge.svg)](https://github.com/anthropics/protobuf-crdt/actions) -->
...
```kotlin
dependencies {
    implementation("com.css.protobuf.crdt:crdt-protoc:1.0.0")
    implementation("com.css.protobuf.crdt:crdt-protoc-data:1.0.0")
}
```
...
```xml
<dependency>
    <groupId>com.css.protobuf.crdt</groupId>
