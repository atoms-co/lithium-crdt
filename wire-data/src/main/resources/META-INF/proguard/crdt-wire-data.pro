...
-keep @interface com.css.protobuf.crdt.data.options.** { *; }
-keep enum com.css.protobuf.crdt.data.options.** { *; }

# Keep classes annotated with any CRDT option
-keep @com.css.protobuf.crdt.data.options.* class * { *; }

# Keep members annotated with CRDT options (preserves $annotations methods)
-keepclassmembers class * {
    @com.css.protobuf.crdt.data.options.** *;
}
