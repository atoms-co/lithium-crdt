    ...
    fun crdtResolver_localMerge() {
        val protoV0 =
            TestMessage(
                ...
                int64Value = 10,
                stringValue = "USD",
                enumValue = com.css.android.internal.shared.storage.crdt.test.EnumSample.VALUE2,
                enumMapValue = mapOf("2" to com.css.android.internal.shared.storage.crdt.test.EnumSample.VALUE1),
            )
