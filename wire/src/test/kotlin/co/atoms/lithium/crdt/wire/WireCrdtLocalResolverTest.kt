...
import co.atoms.lithium.crdt.wire.internal.WireVersionTreeResolver
    ...
    fun crdtResolver_localMerge() {
        val protoV0 =
            TestMessage(
                ...
                int64Value = 10,
                stringValue = "USD",
                enumValue = co.atoms.lithium.crdt.test.EnumSample.VALUE2,
                enumMapValue = mapOf("2" to co.atoms.lithium.crdt.test.EnumSample.VALUE1),
            )
